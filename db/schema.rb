...
ActiveRecord::Schema.define(version: 2020_11_22_134048) do
  ...
  create_table "account_relationships", force: :cascade do |t|
    ...
    t.index ["followed_id"], name: "index_account_relationships_on_followed_id_and_followed_id"
    ...
    t.index ["follower_id"], name: "index_account_relationships_on_follower_id_and_follower_id"
  end
...
# Could not dump table "chaats" because of following StandardError
